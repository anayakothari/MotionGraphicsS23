...
.to("#y",{duration: 0.6, opacity: 1},'-=0.2')
.to("#n",{duration: 0.6, opacity: 1},'-=0.2')
.to("#a",{duration: 0.6, opacity: 1},'-=0.2')
.to("#p",{duration: 0.6, opacity: 1},'-=0.2')
.to("#s2",{duration: 0.6, opacity: 1},'-=0.2')
.to("#e",{duration: 0.6, opacity: 1},'-=0.2')
